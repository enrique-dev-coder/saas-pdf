  ...
  return (
    <main className="mx-auto max-w-7xl md:p-10 ">
      ...
      {files && files?.length !== 0 ? (
        <ul className="mt-8 grid grind-cols-1 gap-6 divide-y divide-zin-200 md:grid-cols-2 lg:grid-cols-3">
          {files
            .sort(
              (a, b) =>
              ...
              >
                ...
                >
                  <div className="pt-6 px-6 flex w-full items-center justify-between space-x-6">
                    <div className="h-10 w-10  flex-shrink-0 rounded-full bg-gradient-to-r from-red-300 to-red-600" />
